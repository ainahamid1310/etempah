...
var D3BarInteraction = function() {
    ...
    var _barInteraction = function() {
        ...
        if(element) {
            ...
            // Demo data set
            // var dataset = [40.9, 33.1, 31.6, 31.0, 29.9, 28.9, 25.2, 25.2, 24.8, 24.3, 24.0, 22.6, 20.5, 19.5, 19.0, 18.9, 18.8, 18.5, 18.4, 17.6, 17.1];
            var dataset = [40.9, 33.1, 31.6, 31.0, 29.9];
