            ...
            var bar_chart = c3.generate({
                ...
                data: {
                    columns: [
                        ...
                        ['Bilik Comcec', rank1],
                        ['Bilik Latihan BPM', rank2],
                        ['Bilik Bincang Admin', rank3],
                        ['Bilik Bincang BPM Aras 19', rank4],
                        ['Bilik Bincang BPm Aras 20', rank5]
                    ],
                    type: 'bar'
                },
                color: {
                    pattern: ['#66bb6a','#ffb980','#2ec7c9','#D604FC', '#B3F321']
                },
                bar: {
                    width: {
                        ratio: 0.5
