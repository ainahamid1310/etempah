...
@section('breadcrumb')
    <div class="breadcrumb">
        ...
        <span class="breadcrumb-item active"> Laporan BIZ POINT</span>
    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header header-elements-inline bg-light">
                <h5 class="card-title">Laporan BIZ POINT</h5>
            </div>
            <form action="/laporan/biz">
                {{ csrf_field() }}
                <div class="card-body">
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ url('/laporan/biz') }}" role="button"><button type="button"
