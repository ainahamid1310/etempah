...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item active">Kemaskini Status</span>
@endsection

@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <legend class="text-uppercase text-info-800 font-weight-bold">Kemaskini Maklumat Status</legend>
        </div>
        ...
        <div class="card-body" style="width: 80%; margin-left: auto; margin-right: auto;">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input name="status_pentadbiran" type="text" class="form-control" value="{{ old('status_pentadbiran', $status->status_pentadbiran) }}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input name="status_pemohon" type="text" class="form-control" value="{{ old('status_pemohon', $status->status_pemohon) }}" required>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input type="checkbox" name="cos" class="form-check-input" @if (old('cos', $status->cos) == '1') checked @endif value="1">
                                CoS
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input type="checkbox" name="psh" class="form-check-input" @if (old('psh', $status->psh) == '1') checked @endif value="1">
                                PSH
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input type="checkbox" name="pli" class="form-check-input" @if (old('pli', $status->pli) == '1') checked @endif value="1">
                                PLI
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <textarea name="keterangan" id="" cols="30" rows="10" class="form-control">{{ old('keterangan', $status->keterangan) }}</textarea>
                    </div>
                </div>
