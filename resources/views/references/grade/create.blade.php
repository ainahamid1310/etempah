...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item active">Daftar Gred</span>
@endsection

@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <legend class="text-uppercase text-info-800 font-weight-bold">Daftar Maklumat Gred</legend>
        </div>
        ...
        <div class="card-body" style="width: 80%; margin-left: auto; margin-right: auto;">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input name="nama" type="text" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" required autofocus>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <select name="kumpulan_perkhidmatan" class="form-control @error('kumpulan_perkhidmatan') is-invalid @enderror" required>
                            <option value="" @if (old('kumpulan_perkhidmatan') == '') selected @endif>- Sila Pilih-</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <textarea name="keterangan" cols="30" rows="10" class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan') }}</textarea>
                    </div>
                </div>
