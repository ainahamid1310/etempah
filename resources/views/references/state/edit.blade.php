...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item active">Sunting Negeri</span>
@endsection

@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <legend class="text-uppercase text-info-800 font-weight-bold">Sunting Maklumat Negeri</legend>
        </div>
        ...
        <div class="card-body" style="width: 80%; margin-left: auto; margin-right: auto;">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input name="nama" type="text" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $state->nama) }}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <textarea name="keterangan" id="" cols="30" rows="10" class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $state->keterangan) }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <select name="status" class="form-control @error('status') is-invalid @enderror">
                            <option value="aktif" @if (old('status', $state->status) == 'aktif') selected @endif>Aktif</option>
                            <option value="tidak aktif" @if (old('status', $state->status) == 'tidak aktif') selected @endif>Tidak Aktif</option>
                        </select>
                    </div>
                </div>
