                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="nama_urusetia" type="text" class="form-control " name="nama_urusetia"
                                        value="{{ old('nama_urusetia') }}" autocomplete="no_sambungan">
                                </div>
                            </div>
                        </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select name="sajian" id="sajian" data-placeholder="Pilih Sajian"
                        ...
                        class="form-control select-search">
                        <option></option>
                        <option value="Tidak Perlu" @if (old('sajian') == 'Tidak Perlu') selected @endif>Tidak Perlu
                        </option>
                        <option value="Pantri Dalaman" @if (old('sajian') == 'Pantri Dalaman') selected @endif>Pantri Dalaman
                        </option>
                        <option value="Katerer Luar" @if (old('sajian') == 'Katerer Luar') selected @endif>Katerer Luar
                        </option>
                    </select>
                </div>
            </div>
