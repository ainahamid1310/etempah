                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <select name="penganjur" id="penganjur" data-placeholder="Pilih Penganjur"
                            class="form-control select-search" onchange="alert_nama_penganjur()" disabled>
                            <option></option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            {{-- @if (!empty($application->applicationRoom->surat))
                                ...
                                <input type="hidden" class="form-control-uniform-custom" name="surat_emel"
                                    value="{{ $application->applicationRoom->surat }}" id="surat_emel" readonly>
                            @endif
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <select name="sajian" id="sajian" data-placeholder="Pilih Sajian"
                            ...
                            class="form-control select-search" disabled="disabled">
                            <option></option>
                            ...
                            <div id="div_minum_pagi">
                                ...
                                <div class="col-md-12">
                                    <div
                                        ...
                                        <input type="checkbox" class="custom-control-input" id="minum_pagi" disabled
                                ...
                                <div class="col-md-12">
                                    <div
                                        ...
                                        <input type="checkbox" class="custom-control-input" id="makan_tengahari"
                                            disabled name="makan_tengahari" value="1"
                                ...
                                <div class="col-md-12">
                                    <div
                                        ...
                                        <input type="checkbox" class="custom-control-input" id="minum_petang"
                                            disabled name="minum_petang" value="1"
                    ...
                    <div class="col-md-9">
                        ...
                        @if (!empty($contains))
                            ...
                            @elseif($application->applicationRoom->status_room_id == '2' ||
                                $application->applicationRoom->statusRoom->status_pentadbiran == '14')
                                <span
                                    class="badge badge-success">{{ $application->applicationRoom->statusRoom->status_pentadbiran }}</span>
                            @elseif($application->applicationRoom->status_room_id == '3' || $application->applicationRoom->status_room_id == '4')
                                <span
                        ...
                        @else
                            @if ($application->applicationRoom->status_room_id == '1')
                                <span
                                    class="badge badge-primary">{{ $application->applicationRoom->statusRoom->status_pemohon }}</span>
                            @elseif($application->applicationRoom->status_room_id == '2' ||
                                $application->applicationRoom->statusRoom->status_pentadbiran == '14')
                                <span
                                    class="badge badge-success">{{ $application->applicationRoom->statusRoom->status_pemohon }}</span>
                            @elseif($application->applicationRoom->status_room_id == '3' || $application->applicationRoom->status_room_id == '4')
                                <span
                                    class="badge badge-danger">{{ $application->applicationRoom->statusRoom->status_pemohon }}</span>
                            @else
                                <span
                                    class="badge badge-secondary">{{ $application->applicationRoom->statusRoom->status_pemohon }}</span>
                            @endif
                        @endif
