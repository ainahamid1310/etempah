                        ...
                        <div class="tab-pane fade show active" id="maklumat_permohonan">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody id="booking-rows">
                                    @php
                                        // Ambil old() kalau ada error, kalau tak ada guna data asal dari DB
                                        $oldBookings = old('bookings', $application->bookings ?? []);
                                    @endphp
                                    ...
                                    @if(count($oldBookings))
                                        @foreach($oldBookings as $i => $booking)
                                            <tr class="booking-row align-middle">
                                                <td>
                                                    <div class="input-group">
                                                        <input type="text" 
                                                            ...
                                                            value="{{ old("bookings.$i.start", is_array($booking) ? $booking['start'] ?? '' : $booking->start ?? '') }}"
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <input type="text" 
                                                            ...
                                                            value="{{ old("bookings.$i.end", is_array($booking) ? $booking['end'] ?? '' : $booking->end ?? '') }}"
                                                ...
                                                <td style="display: flex; align-items: center; gap: 6px; font-size: 1.25rem;">
                                                    ...
                                                    style="{{ $i == 0 ? 'display:none;' : 'display:inline-block;' }}" 
                                                    title="Padam baris">
                                        ...
                                        @endforeach
                                    @else
                                        {{-- fallback kalau memang tiada data langsung --}}
                                        <tr class="booking-row align-middle">
                                            <td>
                                                <div class="input-group">
                                                    <input type="text" 
                                    ...
                                    <div id="form_permohonan" class="collapse show">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control @error('nama_mesyuarat')is-invalid @enderror" name="nama_mesyuarat"
                                            ...
                                            <div id="div_pengerusi" style="display: none">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control @error('nama_pengerusi') is-invalid @enderror" type="text" name="nama_pengerusi"
                                                            id="pengerusi"
