                                    ...
                                    <div id="form_permohonan" class="collapse show">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control date-picker" type="text" id="tarikh_mula"
                                                        name="tarikh_mula" value="{{ formatDateDMY(old('tarikh_mula')) }}"
                                                        onchange="selectRoom()">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control date-picker" type="text" id="tarikh_hingga"
                                                        name="tarikh_hingga" value="{{ formatDateDMY(old('tarikh_hingga')) }}"
                                                        onchange="selectRoom()">
                                                </div>
                                            </div>
...
@section('script')
    ...
    flatpickr(".date-picker", {
        dateFormat: "d/m/Y", // Use full year for parsing
        enableTime: false
    });
...
<script>
function generateTimeFields(startDate, endDate) {
    const container = $('#time-fields');
    ...
    while (current <= end) {
        ...
        container.append(`
            <div class="day-time-group mb-2 p-2 border rounded">
                <strong>${dateStr}</strong><br/>
                <label>Time Start:</label>
                <input type="time" name="time_start[${dateStr}]" required>
                <label>Time End:</label>
                <input type="time" name="time_end[${dateStr}]" required>
            </div>
        `);
...
//     const start = $('#tarikh_mula').val();
//     const end = $('#tarikh_hingga').val();

//     if (start && end) {
//         generateTimeFields(start, end);
//     }
// }

$('#tarikh_mula, #tarikh_hingga').on('change', updateTimeFields);
</script>
