                            ...
                            <div class="card-group-control card-group-control-left">
                                ...
                                <div class="card card bg-light">
                                    ...
                                    <div id="collapsible-control-group1" class="collapse show">
                                        ...
                                        <div class="card-body">
                                            <form method="POST" class="report" id="edit"
                                                action="/report/edit/{{ $application->report->id }}">
                                                {{ csrf_field() }}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="aduan" type="text"
                                                                    class="form-control " name="aduan"
                                                                    value="{{ $application->report->aduan }}" autofocus>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="cadangan" type="text" class="form-control"
                                                                    name="cadangan"
                                                                    value="{{ $application->report->cadangan }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="text-center">
                                                    <button type="submit"
                                                        class="btn bg-success edit-btn">Kemaskini</button>
                                                </div>
                                            </form>
                                        </div>
...
@section('script')
    <script>
        ...
        $('.edit-btn').click(function(event) {
            var form_edit = document.getElementById("edit").form.id;
            form_edit.submit();
