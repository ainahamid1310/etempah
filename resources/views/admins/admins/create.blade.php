    ...
    <div class="card">
        ...
        <div>
                            ...
                            <tr class="form-group">
                                {{-- <div class="form-group row">
                                            ...
                                            <select name="position" id="jawatan" data-placeholder="Pilih Jawatan" class="form-control" disabled>
                                                ...
                                                @if(!empty($user->profile))
                                                    @foreach ($positions as $position)
                                                        <option value="{{ $position->id }}" @if(old('position', $user->profile->position_id) == $position->id) selected @endif>{{ $position->nama }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                            ...
                                            <select name="department" id="department" data-placeholder="Pilih Bahagian" class="form-control" disabled>
                                                ...
                                                @if(!empty($user->profile))
                                                    @foreach ($departments as $department)
                                                        <option value="{{ $department->id }}" @if(old('department', $user->profile->department_id) == $department->id) selected @endif>{{ $department->nama }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            @if(!empty($user->profile))
                                                <input id="no_extension" type="text" placeholder="Contoh : 2378" class="form-control @error('no_extension') is-invalid @enderror" name="no_extension" value="{{ old('no_extension', $user->profile->no_extension) }}" readonly>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            @if(!empty($user->profile))
                                                <input id="no_bimbit" type="text" placeholder="Contoh : 010-2361231" class="form-control @error('no_bimbit') is-invalid @enderror" name="no_bimbit" value="{{ old('no_bimbit', $user->profile->no_bimbit) }}" readonly autocomplete="no_bimbit">
                                            @endif
                                        </div>
                                    </div>
            ...
            <div class="card mb-0 rounded-0 border-y-0">
                <div class="card-header">
                    <h6 class="card-title">
                        <a style="color: blue" class="collapsed text-default" data-toggle="collapse" href="#collapsible-item-group2"><i class="icon-pencil5 mr-2"></i> Tugasan Bilik</a>
                    </h6>
                </div>
