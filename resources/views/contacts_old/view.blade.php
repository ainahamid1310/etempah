...
<div class="breadcrumb">
    ...
    <a href="/reference/department" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Pengurusan Data Rujukan  >  Bahagian</a>
    ...
    <div class="card-header header-elements-inline">
        ...
        <div class="header-elements">
            <div class="list-icons ml-3">
                <a href="/reference/department/create" class="list-icons-item" placeholder="test"><i class="icon-googleplus5 mr-1"></i>Tambah</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
		                <a href="/reference/department/edit/{{ $department->id }}"><span class="badge badge-primary">Edit</span></a>
